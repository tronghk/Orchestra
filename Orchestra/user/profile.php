            ...
            <div class="row row--grid">
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-content-center my-4">
                        ...
                        <a href="profile-edit.php" class="hero__btn hero__btn--green mt-0">Sửa Profile</a>
                    </div>
                </div>
                <!-- end title -->
            </div>
            <?php 
            $namecustomer = $_SESSION['email'];
            $data = mysqli_query($conn, "SELECT customer.name as customername, customer.email as customeremail 
                                                , customer.phone as customerphone  , customer.job as customerjob , 
                                                customer.adress as customeradress , customer.image as customerimg 
											FROM  customer 
											WHERE customer.email = '$namecustomer'");
            ...
            <div class="article article--page">
                ...
                <div class="article__content">
                    <div class="article__artist">
                        <img src="/Orchestra/user/upload/image/<?php echo $row['customerimg'] ?>" alt="">
                        <div>
                            <h1><?php echo $row['customername'] ?></h1>
                            <span>spt: #56488</span>
                        </div>
                    </div>

                    <ul>
                        <li>Họ & Tên: <span><?php echo $row['customername'] ?></span></li>
                        <li>Email: <span><?php echo $row['customeremail'] ?></span></li>
                        <li>Số điện thoại: <span><?php echo $row['customerphone'] ?></span></li>
                        <li>Địa chỉ: <span><?php echo $row['customeradress'] ?></span></li>
                        <li>Nghề nghiệp: <span><?php echo $row['customerjob'] ?></span></li>
                    </ul>
                    ...
                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered
                        ...
                        anything embarrassing hidden in the middle of text. <a href="#">Link</a> the Lorem Ipsum
