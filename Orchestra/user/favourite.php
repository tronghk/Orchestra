<?php 
        ...
        $data = mysqli_query($conn, "SELECT DISTINCT  artist.image as artistimage,  song.name as songname, song.idSong as songid,
												artist.name as artistname
											FROM  song , favorites , artist 
											WHERE song.idSong = favorites.idSong 
			...
			<div class="row row--grid">
				...
				<div class="col-12">
					<ul class="breadcrumb bread">
						...
						<li class="breadcrumb__item breadcrumb__item--active">Favourite</li>
					</ul>
				</div>
				<!-- end breadcrumb -->
			...
			<div class="row row--grid">
				<div class="col-12">
					...
					<?php foreach ($data as $row)  :?>
						<input type="hidden" name="songId" id="songId" value="<?php echo $row['songid']?>">
