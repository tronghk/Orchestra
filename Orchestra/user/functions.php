<?php 
function connect(){
    $conn = new mysqli('localhost', 'root', '', 'quanlyorchestra');
...
function getAllSong(){
    ...
    $res = $conn->query("SELECT song.image as imageSong ,song.link as link,artist.image as artistimg, song.name as songname, artist.name as artistname FROM  artist , song
