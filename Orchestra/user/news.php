					...
					<div class="row row--grid">
						...
						<div class="col-12 col-sm-6 col-lg-4">
							<div class="post">
								...
								<div class="post__content">
									...
									<h3 class="post__title"><a href="article.php">Tom Grennan ‘breaks the internet’ as fans overload servers during virtual gig</a></h3>
						...
						<div class="col-12 col-sm-6 col-lg-4">
							<div class="post">
								...
								<div class="post__content">
									...
									<h3 class="post__title"><a href="article.php">Why do the Golden Globes always get it so wrong?</a></h3>
									<div class="post__meta">
						...
						<div class="col-12 col-sm-6 col-lg-4">
							<div class="post">
								...
								<div class="post__content">
									<a href="#" class="post__category">Music</a>
									<h3 class="post__title"><a href="article.php">Foo Fighters share new live version of ‘No Son Of Mine’</a></h3>
									<div class="post__meta">
