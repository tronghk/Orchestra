...
<body>
						...
						<div class="sign__content">
								...
								if(isset($_POST['submit'])){
									...
									if ($result->num_rows > 0) {
										...
										if($role == 1){
											...
											$s = '/Orchestra/admin/admin/view/QuanLy.php';
									...
									// 			$sql = "select Role from user where UserName = 'admin@gmail.com'";
									// 			$result=$conn->query($sql);
									...
									// 			if($role != 1){
									// 				$s = '/Orchestra/admin/admin/view/QuanLy.php?role='.$role.'';
									// 				echo '<meta http-equiv="refresh" content="0; url= '.$s.'">';
									// 			}
									// 			else
									// 				echo '<meta http-equiv="refresh" content="0; url= index.php">';   
							...
							<form action="#" class="sign__form" method="post">
								...
								<div class="sign__group">
									<input type="email" required class="sign__input" name="email" placeholder="Email">
								</div>
								
								
								<div class="sign__group">
									<input type="password" required class="sign__input" name="pass" placeholder="Password">
								</div>
	...
	<?php
    if(isset($_SESSION['message']) && $_SESSION['message'] != "" &&  $_SESSION['message'] != "Đăng nhập thành công" ){
        echo'
                        <div class="message-action" style="width:100%;display:flex;justify-content:center; height:200px ">
                        <div id="msgAlert" class="panel-body text-center" style="position: fixed;top:0;z-index: 10001; width:100%;background-color:white;height:40px;text-align:center;">
