<?php 
        ...
        $data = mysqli_query($conn, "SELECT song.image as imageSong, song.link as link ,artist.image as artistimage, song.name as songname, album.name as albumname, artist.name as artistname FROM  album , artist , song
    ...
    <div class="col-6 col-sm-4 col-lg-2">
        <div class="album">
            <div class="album__cover">
                ...
                <a style="cursor: pointer;" onclick="changeSong('/music/<?php echo $row['link'] ?>','<?php echo $row['songname'] ?>','<?php echo $row['artistname'] ?>');"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path
