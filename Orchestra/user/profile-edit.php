    ...
    <div class="container-fluid" style="display: block;">
            <div class="row row--grid">
                ...
                <div class="col-12">
                    <ul class="breadcrumb bread">
                        ...
                        <li class="breadcrumb__item breadcrumb__item--active">Profile edit</li>
                    </ul>
                </div>
                <!-- end breadcrumb -->
            ...
            <div class="row row--grid">
                ...
                <?php 
								...
								$errors=[];
								$nameErr = $emailErr = $addressErr = $jobErr = $phoneErr =$adressErr  = $check = "";
								if(isset($_POST['submit'])){
									...
									// 	$adressErr = "Chỉ cho phép chữ cái và khoảng trắng";
									//   }

                                    // if (!preg_match("/^[a-zA-Z-' ]*$/",$job)) {
									// 	$jobErr = "Chỉ cho phép chữ cái và khoảng trắng";
									//   }
									...
									if(count($errors)>0){
                                        ...
                                        $id = $_SESSION['dangki'];
										// $sql = "UPDATE `customer` SET `email`='$mail',`name`='$name',
                                        // `phone`='$phone',`job`='$job',`adress`='$adress' WHERE  `name`='$id'";  
                                        $sql = "UPDATE customer  INNER JOIN user
                                        ON customer.email = user.UserName
                                        SET customer.email = '$mail', customer.name = '$name',
                                        customer.phone= '$phone', customer.job = '$job', customer.adress = '$adress',  
                                        user.UserName =  '$mail'  WHERE  `name`='$id' ";
                                        $data=$conn->query($sql);
                                        ...
                                        if (isset($_FILES['image'])) {
                                            ...
                                            move_uploaded_file($_FILES['image']['tmp_name'], $upload_dir . $subdir . $nameimg);
            
                                            // 3.2. Lưu thông tin file upload vào database
                                            // Câu lệnh UPDATE
                                            $sql = "update customer set image = '$nameimg' where name ='$id'";
                                            // print_r($sql); die;
					...
					?>
                    <form action="#" class="sign__form sign__form--contacts" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="sign__group">
                                    <input readonly="readonly" value="<?php echo $_SESSION['email']; ?>" type="text" name="email" class="sign__input" placeholder="Email">
                                </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="sign__group">
                                    <input type="text" name="address" class="sign__input" placeholder="address">
                                </div>
                            ...
                            <div class="col-12">
                                <div class="sign__group">
                                    <input type="text" name="job" class="sign__input" placeholder="job">
                                </div>
                                <span class="error"> <?php echo $jobErr;?></span>
                            </div>

                            <div class="form-group col-12 mb-2">
                                <label style="color: #fff;">Avatar Image: </label>
                                <label id="projectinput8" class="file center-block" style="color: #fff;">
                            ...
                            <div class="col-12 col-xl-3">
                                <div class="d-flex justify-content-between align-content-center my-2">
                                    <button type="submit" name="submit" class="sign__btn">Send</button>
                                    <a href="profile.php" class="sign__btn mx-2" style="background-color: #c40808;">
                                        Cancel </a>
                                </div>
                            </div>
                        </div>
